...
const PitchbookLanding = () => (
  ...
  <React.Fragment>
    <div className="container full-pitchbook full-height">
      <div className="partner">
        ...
        <div className="partner description">
          <p>
            ...
            start we have grown and changed immensely. There are few who understand startups like
            the folks at Pitchbook, and we hope you'll try our wash and fold laundry delivery service 
            and get as excited about it as we are. In addition to receiving a free Loopie Duffel, 
            you will get $10.00 off your first order if you sign up now with code: Pitchbook.{' '}
          </p>
